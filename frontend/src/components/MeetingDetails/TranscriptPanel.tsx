...
export function TranscriptPanel({
  ...
  const hasSpeakers = transcripts.some(t => t.speaker);
  ...
  return (
    <>
      ...
      {/* Transcript content */}
      <div className="flex-1 overflow-y-auto pb-4" id="transcript-scroll-container">
      ...
      {showSpeakerManager && onSpeakerUpdate && onSpeakerMerge && (
        <SpeakerManager
