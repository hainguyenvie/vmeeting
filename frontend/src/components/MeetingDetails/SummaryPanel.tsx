    ...
    <div className="flex-1 min-w-0 flex flex-col bg-white overflow-hidden">
      ...
      {isSummaryLoading ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {/* Legacy Summary Response View - Only show if raw_summary exists and structure is legacy */}
          {summaryResponse && summaryResponse.raw_summary && !aiSummary.key_points && (
            /* This block was showing legacy response, but now we assume BlockNote handles it */
            null
          )}
