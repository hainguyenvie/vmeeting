...
export const RecordingStatusBar: React.FC<RecordingStatusBarProps> = ({ isPaused = false }) => {
  ...
  // Note: We rely solely on backend activeDuration updates (polled every 500ms in RecordingStateContext)
  // This prevents race conditions between local timer and backend sync that caused jumps on first recording
