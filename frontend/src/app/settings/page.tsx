...
// import { invoke } from '@tauri-apps/api/core'; // ⚠️ DISABLED FOR WEB VERSION
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    const loadTranscriptConfig = async () => {
      try {
        // ⚠️ WEB VERSION: Use localStorage instead of Tauri invoke
  ...
  const handleSaveConfig = async (config: TranscriptModelProps) => {
    try {
      ...
      // ⚠️ WEB VERSION: Use localStorage instead of Tauri invoke
      localStorage.setItem('transcript_config', JSON.stringify({
